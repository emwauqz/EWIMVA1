...
care: "Ручная стирка при 30 °С, Отбеливать запрещено, Гладить при 110 °С, Химчистка запрещена, Запрещено сушить в сушилке",
photosLarge: [
    { src: "/87060612-05-99999999-01.png", alt: "Pervayz" },
    { src: "/87060612-05-99999999-01.png", alt: "Element r" },
],
photosSmall: [
    { src: "/87098645-05-01-d1.png", alt: "Element" },
    { src: "/87098645-05-01-d8.png", alt: "Element" },
...
care: "Ручная стирка при 30 °С, Отбеливать запрещено, Гладить при 110 °С, Химчистка запрещена, Запрещено сушить в сушилке",
photosLarge: [
    { src: "/87038267-05-d2-1.png", alt: "Pervayz" },
    { src: "/87038267-05-d2-1.png", alt: "Element r" },
],
photosSmall: [
    { src: "/87098645-05-01-d1.png", alt: "Element" },
    { src: "/87098645-05-01-d8.png", alt: "Element" },
...
care: "Ручная стирка при 30 °С, Отбеливать запрещено, Гладить при 110 °С, Химчистка запрещена, Запрещено сушить в сушилке",
photosLarge: [
    { src: "/87085755-07.png", alt: "Pervayz" },
    { src: "/87085755-07.png", alt: "Element r" },
],
photosSmall: [
    { src: "/87098645-05-01-d1.png", alt: "Element" },
    { src: "/87098645-05-01-d8.png", alt: "Element" },
...
care: "Ручная стирка при 30 °С, Отбеливать запрещено, Гладить при 110 °С, Химчистка запрещена, Запрещено сушить в сушилке",
photosLarge: [
    { src: "/87067706-06-d2--1-.png", alt: "Pervayz" },
    { src: "/87067706-06-d2--1-.png", alt: "Element r" },
],
photosSmall: [
    { src: "/87098645-05-01-d1.png", alt: "Element" },
    { src: "/87098645-05-01-d8.png", alt: "Element" },
...
care: "Ручная стирка при 30 °С, Отбеливать запрещено, Гладить при 110 °С, Химчистка запрещена, Запрещено сушить в сушилке",
photosLarge: [
    { src: "/87075741-ts-02-d7.png", alt: "Pervayz" },
    { src: "/87075741-ts-02-d7.png", alt: "Element r" },
],
photosSmall: [
    { src: "/87098645-05-01-d1.png", alt: "Element" },
    { src: "/87098645-05-01-d8.png", alt: "Element" },

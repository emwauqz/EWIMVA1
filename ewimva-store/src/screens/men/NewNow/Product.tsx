...
// {
// id: 1,
// name: 'Брюки slim fit 100% хлопок',
// category: 'CAPSULE',
// price: 'KGS 7 990',
// image: '/Брюки slim fit 100% хлопок.png',
// colorVariants: [],
// composition: "63% viscose, 37% polyamide",
// origin: "Разработано в Барселоне, Производство: Китай",
// care: "Ручная стирка при 30 °С, Отбеливать запрещено, Гладить при 110 °С, Химчистка запрещена, Запрещено сушить в сушилке",
// photosLarge: [
//     { src: "/Брюки slim fit 100% хлопок.png", alt: "1" },
//     { src: "/Брюки slim fit 100% хлопок_2.png", alt: "2" },
// ],
// photosSmall: [
//     { src: "/Брюки slim fit 100% хлопок_3.png", alt: "3" },
//     { src: "/Брюки slim fit 100% хлопок_4.png", alt: "4" },
//     { src: "/Брюки slim fit 100% хлопок_5.png", alt: "5" },
//     { src: "/Брюки slim fit 100% хлопок_6.png", alt: "6" },
// ],
// color: "Глубокий темно-синий",
// description: "Приталенный крой. Застежка на ремешок с пуговицей. Шлевки для ремня. Двойная застежка на пуговицу и молнию. Два боковых кармана. Два задних кармана с кантом. Модель ростом 190 см и носит размер 42. ",
// },
// {
// id: 2,
